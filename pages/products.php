            ...
            <div style="width: 320px; flex-shrink: 0;">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                    ...
                    <div class="p-4 border-b border-gray-100">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button onclick="setQuickPrice(0, 25)" class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition">₺0-25</button>
                                <button onclick="setQuickPrice(25, 50)" class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition">₺25-50</button>
                                <button onclick="setQuickPrice(50, 100)" class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition">₺50-100</button>
                                <button onclick="setQuickPrice(100, null)" class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition">₺100+</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <select id="sort-select" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <div style="flex: 1; min-width: 0;">
                ...
                <div class="text-center mt-12">
                    ...
                    >
                        ...
                        <svg id="load-more-spinner" class="hidden animate-spin ml-2 h-4 w-4 text-gray-700 inline" fill="none" viewBox="0 0 24 24">
...
<div id="mobile-filters-overlay" class="fixed inset-0 bg-black bg-opacity-50 z-50 lg:hidden" style="display: none;" onclick="toggleMobileFilters()">
...
async function loadCategories() {
    try {
        const response = await apiCall('categories?with_count=true');
