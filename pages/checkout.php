                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-blue-700 mb-4">
                            Şu anda sadece havale/EFT ile ödeme kabul ediyoruz. Diğer ödeme yöntemleri yakında eklenecektir.
                        </p>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-blue-200">
                            ...
                            <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                                <p class="text-sm text-yellow-800">
                                    <strong>Önemli:</strong> Havale/EFT yaparken açıklama kısmına mutlaka sipariş numaranızı yazın.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <form id="receipt-form" class="space-y-6">
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                        ...
                        <div id="upload-area" onclick="document.getElementById('receipt-file').click()" class="cursor-pointer">
...
async function loadOrderSummary() {
    try {
        ...
        const cartItems = response.success ? response.data : [];
...
async function completeOrder() {
    ...
    try {
        ...
        if (!uploadResult.success) {
            throw new Error('Dekont yüklenemedi: ' + uploadResult.message);
        }
        ...
        const orderResponse = await apiCall('orders', {
            ...
            body: JSON.stringify({
                ...
                payment_proof: uploadResult.data.url,
                transfer_note: document.getElementById('transfer-note').value
            })
        });
        ...
        if (orderResponse.success) {
            ...
            setTimeout(() => {
                window.location.href = `/orders?success=${orderResponse.order_number}`;
            }, 2000);
        }
