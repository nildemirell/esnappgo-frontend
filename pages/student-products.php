...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Products Grid -->
        <div id="student-products-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <!-- Loading skeleton -->
            <?php for ($i = 0; $i < 8; $i++): ?>
        ...
        const products = [
            {
                id: 1,
                title: 'Taze Domates',
                description: 'Yerel üreticiden taze domates',
                price: 8.50,
                status: 'active',
                images: ['https://images.unsplash.com/photo-1546470427-227d7d82cd5b?w=400'],
