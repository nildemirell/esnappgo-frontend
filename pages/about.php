<div class="min-h-screen bg-white">
    <!-- Hero Section -->
    <section
        class="relative bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-900 text-white py-24 overflow-hidden">
        <div
            class="pointer-events-none absolute -top-24 -left-24 w-[500px] h-[500px] rounded-full bg-blue-500 opacity-20 blur-3xl animate-pulse">
        </div>
        <div class="pointer-events-none absolute -bottom-32 -right-20 w-[600px] h-[600px] rounded-full bg-purple-500 opacity-20 blur-3xl"
            style="animation: pulse 4s ease-in-out infinite;"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div
                class="inline-flex items-center px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-blue-200 font-semibold mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold text-yellow-300 mb-2" id="about-students">1.2K+</div>
                    <div class="text-sm text-blue-200">Aktif Öğrenci</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold text-yellow-300 mb-2" id="about-merchants">150+</div>
                    <div class="text-sm text-blue-200">Yerel Esnaf</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold text-yellow-300 mb-2" id="about-products">3.5K+</div>
                    <div class="text-sm text-blue-200">Ürün</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold text-yellow-300 mb-2" id="about-customers">10K+</div>
    ...
    <section class="relative py-24 bg-gradient-to-br from-teal-50 via-blue-50 to-indigo-100 overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <svg class="absolute top-1/4 left-0 transform -translate-x-1/2" width="600" height="600"
                ...
                <path
                    ...
                    fill="rgba(16, 185, 129, 0.04)" opacity="0.3" />
            </svg>
            <svg class="absolute top-1/2 right-0 transform translate-x-1/3" width="500" height="500"
                viewBox="0 0 500 500" fill="none">
                <ellipse cx="250" cy="250" rx="200" ry="150" fill="rgba(139, 92, 246, 0.03)" opacity="0.4" />
            </svg>
            <svg class="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/4" width="400" height="400"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-10">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-8">
                    ...
                    <p class="text-lg text-gray-700 font-semibold mb-6 leading-relaxed">
                        E-ticareti sadece bir alışveriş alanı olmaktan çıkarıp, gençlerin geleceğini güçlendiren ve
                        yerel ekonomiyi canlandıran bir değer ekosistemine dönüştürmek.
                    </p>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed">
                        EsnappGO olarak amacımız, üniversite öğrencilerinin sahada ürettikleri gerçek içerikleri; yerel
                        esnafların güvenle doğruladığı ürünlerle buluşturmak ve bu işbirliğini topluma fayda sağlayan
                        kalıcı bir modele dönüştürmektir.
                    </p>
                    ...
                    <p class="text-base text-gray-700 font-medium leading-relaxed">
                        Biz, ekonomik döngüleri gençlerin enerjisiyle yeniden tasarlıyor ve <span
                            class="text-blue-600 font-semibold">"her alışveriş topluma değer katmalı"</span> fikrini
                        merkezimize alıyoruz.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-10">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-lg text-gray-700 font-semibold mb-6 leading-relaxed">
                        Türkiye'de ve dünyada sosyal değer odaklı e-ticaretin öncüsü olmak; gençleri üretimin merkezine
                        koyan, yerel ekonomileri güçlendiren ve sürdürülebilir bir gelecek inşa eden küresel bir model
                        yaratmak.
                    </p>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed">
                        Geleceğin ticaret dünyasında gençlerin yalnızca tüketici değil, <span
                            class="font-semibold text-purple-600">üretici, araştırmacı ve değişim taşıyıcıları</span>
                        olduğuna inanıyoruz.
                    </p>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed">
                        Bu nedenle vizyonumuz, öğrencilerin sahadaki enerjisini; teknolojinin gücü ve esnafların
                        deneyimiyle birleştirerek toplumsal fayda yaratan bir ekonomik sistem kurmaktır.
                    </p>
                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-100">
                        ...
                        <ul class="space-y-3 text-purple-800 text-sm leading-relaxed">
                            <li class="flex items-start">
                                <svg class="w-5 h-5 mr-3 text-purple-600 flex-shrink-0 mt-0.5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                </svg>
                                <span>Türkiye'nin her şehrinde öğrenci ve esnaf işbirliğiyle büyüyen sürdürülebilir bir
                                    dijital pazar ağı oluşturmak,</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 mr-3 text-purple-600 flex-shrink-0 mt-0.5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span>Bu modeli uluslararası düzeye taşıyarak dünyanın farklı ülkelerinde sosyal etki
                                    odaklı e-ticaret ekosistemleri geliştirmek,</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 mr-3 text-purple-600 flex-shrink-0 mt-0.5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span>Gençlerin ekonomik özgüvenini artıran, şehir ekonomilerini güçlendiren ve
                                    toplumsal dayanışmayı büyüten yeni sosyal değer alanları yaratmak,</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 mr-3 text-purple-600 flex-shrink-0 mt-0.5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span>E-ticaret sektörüne, <span class="font-semibold">"karar verici olan tüketici
                                        değil; değer yaratan gençtir"</span> fikrini yerleştirmek istiyoruz.</span>
                            </li>
                        </ul>
                    </div>

                    <p class="text-base text-gray-700 font-medium mt-6 leading-relaxed">
                        Vizyonumuz, sadece bir platform kurmak değil; <span
                            class="text-purple-600 font-semibold">geleceğin ekonomik kültürünü dönüştürmektir.</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-0 left-0 w-full h-40 overflow-hidden">
            <svg class="absolute bottom-0 w-full h-full" viewBox="0 0 1200 200" preserveAspectRatio="none">
                ...
                <path d="M0,200 C200,120 400,140 600,100 C800,60 1000,80 1200,120 L1200,200 Z"
                    fill="url(#about-gradient-1)" opacity="0.8" />
                <path d="M0,200 C150,160 350,150 550,180 C750,210 950,190 1200,160 L1200,200 Z"
                    fill="rgba(16, 185, 129, 0.06)" opacity="0.7" />
            </svg>
        </div>
    </section>
    ...
    <section class="relative py-24 bg-white overflow-hidden">
        ...
        <div class="absolute inset-0">
            <svg class="absolute top-0 right-1/4 transform translate-x-1/2 -translate-y-1/2" width="400" height="400"
                viewBox="0 0 400 400" fill="none">
                <ellipse cx="200" cy="200" rx="150" ry="100" fill="rgba(251, 191, 36, 0.06)" opacity="0.7" />
            </svg>
            <svg class="absolute bottom-0 left-1/4 transform -translate-x-1/2 translate-y-1/2" width="350" height="350"
                viewBox="0 0 350 350" fill="none">
                <circle cx="175" cy="175" r="120" fill="rgba(236, 72, 153, 0.05)" opacity="0.8" />
            </svg>
            <svg class="absolute top-1/2 left-0 transform -translate-x-1/3" width="300" height="300"
                viewBox="0 0 300 300" fill="none">
                <path
                    d="M150,30 C210,30 260,80 260,150 C260,220 210,270 150,270 C90,270 40,220 40,150 C40,80 90,30 150,30 Z"
                    fill="rgba(16, 185, 129, 0.04)" opacity="0.6" />
            </svg>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="relative group text-center">
                    <div
                        class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 hover:shadow-xl transition-all transform hover:-translate-y-2">
                        <div
                            class="w-24 h-24 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform shadow-lg">
                            <span class="text-3xl font-bold text-white">1</span>
                        </div>
                        <div
                            class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative group text-center">
                    <div
                        class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 hover:shadow-xl transition-all transform hover:-translate-y-2">
                        <div
                            class="w-24 h-24 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform shadow-lg">
                ...
                <div class="group text-center">
                    <div
                        class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 hover:shadow-xl transition-all transform hover:-translate-y-2">
                        <div
                            class="w-24 h-24 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform shadow-lg">
        ...
        <div class="absolute bottom-0 left-0 w-full h-32 overflow-hidden">
            <svg class="absolute bottom-0 w-full h-full" viewBox="0 0 1200 160" preserveAspectRatio="none">
                ...
                <path d="M0,160 C300,100 500,80 700,120 C900,160 1100,140 1200,100 L1200,160 Z"
                    fill="url(#about-gradient-2)" opacity="0.7" />
            </svg>
        </div>
    </section>
    ...
    <section class="relative py-24 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <svg class="absolute top-0 left-0 w-full h-full" viewBox="0 0 1200 800" fill="none"
                ...
                <path d="M0,400 C200,320 400,280 600,340 C800,400 1000,380 1200,320 L1200,0 L0,0 Z"
                    fill="rgba(59, 130, 246, 0.05)" opacity="0.8" />
                <path d="M0,600 C300,520 500,480 700,540 C900,600 1100,580 1200,520 L1200,800 L0,800 Z"
                    fill="rgba(16, 185, 129, 0.04)" opacity="0.9" />
                <path d="M0,200 C250,140 450,120 650,160 C850,200 1050,180 1200,140 L1200,0 L0,0 Z"
                    fill="rgba(251, 191, 36, 0.03)" opacity="0.7" />
            </svg>

            <!-- Floating organic blobs -->
            <svg class="absolute top-1/4 right-1/4 transform translate-x-1/2" width="300" height="300"
                viewBox="0 0 300 300" fill="none">
                <circle cx="150" cy="150" r="100" fill="rgba(139, 92, 246, 0.06)" opacity="0.6" />
            </svg>

            <svg class="absolute bottom-1/4 left-1/4 transform -translate-x-1/2" width="250" height="250"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    class="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z">
                            </path>
                ...
                <div
                    class="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
                    <div
                        class="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z">
                            </path>
        ...
        <div class="absolute bottom-0 left-0 w-full h-36 overflow-hidden">
            <svg class="absolute bottom-0 w-full h-full" viewBox="0 0 1200 180" preserveAspectRatio="none">
                ...
                <path d="M0,180 C250,120 450,100 650,140 C850,180 1050,160 1200,120 L1200,180 Z"
                    fill="url(#about-gradient-3)" opacity="0.8" />
                <path d="M0,180 C200,140 400,130 600,160 C800,190 1000,170 1200,140 L1200,180 Z"
                    fill="rgba(139, 92, 246, 0.04)" opacity="0.6" />
            </svg>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="text-center">
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <div class="text-center">
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6">
                            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="text-center">
                    <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-6">
                            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                                </path>
        ...
        <div class="absolute bottom-0 left-0 w-full h-32 overflow-hidden">
            <svg class="absolute bottom-0 w-full h-full" viewBox="0 0 1200 160" preserveAspectRatio="none">
                ...
                <path d="M0,160 C300,100 500,120 700,80 C900,40 1100,60 1200,100 L1200,160 Z"
                    fill="url(#about-gradient-4)" opacity="0.7" />
            </svg>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-3xl shadow-xl p-12 text-center">
                    <div
                        class="w-32 h-32 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-xl">
    ...
    <!-- CTA Section -->
    <section
        class="relative bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-800 text-white py-24 overflow-hidden">
        <div
            class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.1),transparent_50%),radial-gradient(circle_at_70%_80%,rgba(255,255,255,0.08),transparent_50%)]">
        </div>
        <div
            class="pointer-events-none absolute -top-24 -left-24 w-[400px] h-[400px] rounded-full bg-blue-400 opacity-20 blur-3xl animate-pulse">
        </div>
        <div class="pointer-events-none absolute -bottom-32 -right-20 w-[500px] h-[500px] rounded-full bg-purple-400 opacity-20 blur-3xl"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col lg:flex-row gap-6 justify-center mb-12">
                <a href="/register?role=customer"
                    class="group bg-white text-blue-900 px-12 py-5 rounded-full font-bold text-lg hover:bg-blue-50 transition-all transform hover:scale-105 shadow-2xl">
                    <svg class="w-6 h-6 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                    </svg>
                    Alışverişe Başla
                    <svg class="w-5 h-5 inline ml-3 group-hover:translate-x-1 transition-transform" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
                ...
                <a href="/register?role=student"
                    class="group border-3 border-white text-white px-12 py-5 rounded-full font-bold text-lg hover:bg-white hover:text-blue-900 transition-all transform hover:scale-105">
                    <svg class="w-6 h-6 inline mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                        </path>
