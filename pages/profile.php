        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <nav class="bg-white rounded-lg shadow-sm p-4 space-y-1">
                    <a href="#profile-info" onclick="showSection('profile-info')" class="profile-nav-link active flex items-center px-3 py-2 text-sm font-medium rounded-md">
                    ...
                    <a href="#password" onclick="showSection('password')" class="profile-nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#addresses" onclick="showSection('addresses')" class="profile-nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#notifications" onclick="showSection('notifications')" class="profile-nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
