...
<div class="py-10 bg-gray-50 flex items-center justify-center p-4 sm:p-6 font-sans min-h-[calc(100vh-100px)] w-full">
    <div
        class="bg-white w-full max-w-5xl rounded-[32px] overflow-hidden flex shadow-[0_20px_50px_rgba(0,0,0,0.1)] min-h-[600px]">
        ...
        <div class="w-5/12 bg-[#E9E9E9] hidden md:flex flex-col items-center justify-center relative p-8">
            <div class="absolute top-10 left-10">
                <h2 class="text-3xl font-bold text-black tracking-tight" style="font-family: 'Inter', sans-serif;">
                    EsnappGO<span class="text-blue-600">.</span></h2>
            </div>
        ...
        <div class="w-full md:w-7/12 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            <div class="w-full max-w-sm mx-auto">
                <div class="md:hidden text-center mb-8">
                    <h2 class="text-4xl font-bold text-black tracking-tight">EsnappGO<span
                    ...
                    <div class="pb-6 mb-2">
                        <div class="relative mt-2">
                            <input id="email" name="email" type="email" autocomplete="email" required
                                ...
                                style="-webkit-box-shadow: 0 0 0px 1000px white inset;" placeholder=" " />
                            <label for="email"
                                class="pointer-events-none absolute left-0 top-14 text-sm font-semibold text-gray-500 transition-all peer-placeholder-shown:top-14 peer-focus:top-14 peer-[&:-webkit-autofill]:top-14">
                                E-posta
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <div class="flex items-center">
                            ...
                            <label for="remember-me"
                                class="ml-2 block text-sm font-medium text-gray-600 cursor-pointer">
                                30 gün hatırla
                            </label>
                        </div>
                        <div class="text-sm">
        ...
        form.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (response.token) {
                    ...
                    document.cookie = "ui_role=" + response.role + "; path=/; max-age=2592000;";
