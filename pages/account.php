        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1">
                <nav class="bg-white rounded-lg shadow-sm p-4 space-y-1">
                    ...
                    <a href="#addresses" onclick="showSection('addresses')" class="account-nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#payment-methods" onclick="showSection('payment-methods')" class="account-nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <form id="personal-info-form" class="space-y-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label for="full_name" class="block text-sm font-medium text-gray-700 mb-2">Ad Soyad</label>
                                    <input type="text" id="full_name" name="full_name" value="<?php echo htmlspecialchars($current_user['full_name']); ?>" class="w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" required />
                                </div>
                                
                                <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700 mb-2">E-posta</label>
                                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($current_user['email']); ?>" class="w-full rounded-md border-gray-300 bg-gray-100 py-2 px-3 border" disabled />
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($current_user['phoneNumber'] ?? $current_user['phone'] ?? ''); ?>" class="block w-full rounded-md border-gray-300 bg-gray-50 pr-20 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 sm:text-sm transition-colors" placeholder="05XX XXX XX XX" readonly />
                                    <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                        <button type="button" id="edit-phone-btn" class="text-sm font-medium text-blue-600 hover:text-blue-500 focus:outline-none bg-transparent">Güncelle</button>
                                    </div>
                                </div>
                                <p id="phone-hint" class="text-xs text-blue-600 mt-1 hidden">Yeni numaranızı girip aşağıdaki 'Değişiklikleri Kaydet' butonuna basın.</p>
                            </div>
                            
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                                <div>
                                    <label for="gender" class="block text-sm font-medium text-gray-700 mb-2">Cinsiyet</label>
                                    <select id="gender" name="gender" class="w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border">
                                        ...
                                        <option value="other" <?php echo (isset($current_user['gender']) && $current_user['gender'] == 'other') ? 'selected' : ''; ?>>Belirtmek İstemiyorum</option>
                                    </select>
                                </div>
                                
                                <div>
                                    <label for="birth_date" class="block text-sm font-medium text-gray-700 mb-2">Doğum Tarihi</label>
                                    <input type="date" id="birth_date" name="birth_date" value="<?php echo htmlspecialchars($current_user['birth_date'] ?? ''); ?>" class="w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" />
                                </div>
                            </div>
                            
                            <div class="flex justify-end">
                                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium">Değişiklikleri Kaydet</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div id="addresses" class="account-section" style="display: none;">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button id="add-address-btn" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium text-sm flex items-center">
                            ...
                            <div class="border border-gray-200 rounded-lg p-5 relative hover:border-blue-500 transition-colors group">
                             ...
                             <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                ...
                                <h4 class="font-semibold text-gray-900 mb-2 flex items-center">
                                    Ev Adresim
                                    <span class="ml-3 px-2 py-0.5 bg-green-100 text-green-800 text-xs font-medium rounded">Varsayılan Teslimat</span>
                                </h4>
                                <div class="text-sm text-gray-600 mb-3 space-y-1">
                                    <p><strong><?php echo htmlspecialchars($current_user['full_name']); ?></strong> - <?php echo htmlspecialchars($current_user['phoneNumber'] ?? 'Telefon Yok'); ?></p>
                ...
                <div id="payment-methods" class="account-section" style="display: none;">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button id="add-card-btn" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium text-sm flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                                Yeni Kart Ekle
                            </button>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <form id="password-form" class="space-y-4">
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        <input type="password" id="current_password" name="current_password" class="w-full pr-10 rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" required />
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        <input type="password" id="new_password" name="new_password" class="w-full pr-10 rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" minlength="6" required />
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        <input type="password" id="confirm_password" name="confirm_password" class="w-full pr-10 rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" required />
                                ...
                                <div class="flex justify-end">
                                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium">Şifreyi Değiştir</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <form id="notifications-form" class="space-y-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                <button type="submit" id="save-notif-btn" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium">Ayarları Kaydet</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div id="privacy" class="account-section" style="display: none;">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 font-medium">Ayarları Kaydet</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <form id="delete-account-form">
                            <div class="mb-4">
                                ...
                                <input type="text" id="delete_confirmation" name="delete_confirmation" class="w-full rounded-md border-gray-300 focus:border-red-500 focus:ring-red-500 py-2 px-3 border" placeholder="HESABI SİL" required />
                            </div>
                            <div class="flex justify-end">
                                <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 font-medium">Hesabı Kalıcı Olarak Sil</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<div id="address-modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden z-50 flex items-center justify-center transition-opacity">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-xl p-6 m-4">
        ...
        <form id="mock-address-form" class="space-y-4">
            <input type="text" id="mock_addr_title" placeholder="Adres Başlığı (Örn: İş Yeri)" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white">
            
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <select id="mock_addr_city" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white">
                        <option value="">Şehirler Yükleniyor...</option>
                    </select>
                </div>
                <div>
                    <select id="mock_addr_district" required disabled class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500 bg-white">
                        <option value="">Önce İl Seçiniz</option>
                    </select>
                </div>
            </div>
            
            <textarea id="mock_addr_detail" placeholder="Açık Adres (Mahalle, Sokak, No...)" required rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white"></textarea>
            <div class="flex justify-end space-x-3 mt-6">
                <button type="button" onclick="closeModal('address-modal')" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 font-medium">İptal</button>
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">Kaydet</button>
            </div>
        </form>
    </div>
</div>

<div id="card-modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden z-50 flex items-center justify-center transition-opacity">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 m-4">
        ...
        <form id="mock-card-form" class="space-y-4">
            <input type="text" id="mock_card_name" placeholder="Kart Üzerindeki İsim" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
            <input type="text" id="mock_card_number" placeholder="Kart Numarası (16 Hane)" maxlength="19" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
            <div class="grid grid-cols-2 gap-4">
                <input type="text" id="mock_card_expiry" placeholder="AA/YY" maxlength="5" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                <input type="text" id="mock_card_cvc" placeholder="CVC" maxlength="3" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="flex justify-end space-x-3 mt-6">
                <button type="button" onclick="closeModal('card-modal')" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 font-medium">İptal</button>
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">Ekle</button>
            </div>
        </form>
    </div>
</div>
